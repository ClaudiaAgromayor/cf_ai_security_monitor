...
export function SecurityEventReporter() {
  ...
  const [response, setResponse] = useState<SecurityAlert | null>(null);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const data = (await res.json()) as SecurityAlert;
      setResponse(data);
      ...
      <Card className="border-blue-200 bg-blue-50">
        <div className="space-y-3">
          ...
          <div className="space-y-2 text-sm text-blue-800">
            <p>
              <strong>Brute Force:</strong> Type: Login Attempt, Source:
              203.0.113.1, Description: "Failed password authentication - 10
              attempts in 5 minutes"
            </p>
            <p>
              <strong>Data Exfiltration:</strong> Type: Data Access, Source:
              user-456, Description: "Downloaded 50GB of customer data"
            </p>
            <p>
              <strong>Config Change:</strong> Type: Config Change, Source:
              admin, Description: "Disabled firewall rules"
            </p>
          </div>
        </div>
      </Card>
